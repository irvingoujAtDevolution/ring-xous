...
(*batch)
.w[i.wrapping_add(2 as std::os::raw::c_int as u64)
as usize] = *in_0.offset(1 as std::os::raw::c_int as isize);
(*batch)
.w[i.wrapping_add(4 as std::os::raw::c_int as u64)
as usize] = *in_0.offset(2 as std::os::raw::c_int as isize);
(*batch)
.w[i.wrapping_add(6 as std::os::raw::c_int as u64)
as usize] = *in_0.offset(3 as std::os::raw::c_int as isize);
}
#[inline]
...
return a0 as uint32_t | (a1 as uint32_t) << 8 as std::os::raw::c_int
| (a2 as uint32_t) << 16 as std::os::raw::c_int | (a3 as uint32_t) << 24 as std::os::raw::c_int;
}
#[inline]
...
aes_nohw_swap_bits(
&mut *((*batch).w).as_mut_ptr().offset(0 as std::os::raw::c_int as isize),
&mut *((*batch).w).as_mut_ptr().offset(1 as std::os::raw::c_int as isize),
0x55555555 as std::os::raw::c_int as uint32_t,
1 as std::os::raw::c_int as aes_word_t,
);
aes_nohw_swap_bits(
&mut *((*batch).w).as_mut_ptr().offset(2 as std::os::raw::c_int as isize),
&mut *((*batch).w).as_mut_ptr().offset(3 as std::os::raw::c_int as isize),
0x55555555 as std::os::raw::c_int as uint32_t,
1 as std::os::raw::c_int as aes_word_t,
);
aes_nohw_swap_bits(
&mut *((*batch).w).as_mut_ptr().offset(4 as std::os::raw::c_int as isize),
&mut *((*batch).w).as_mut_ptr().offset(5 as std::os::raw::c_int as isize),
0x55555555 as std::os::raw::c_int as uint32_t,
1 as std::os::raw::c_int as aes_word_t,
);
aes_nohw_swap_bits(
&mut *((*batch).w).as_mut_ptr().offset(6 as std::os::raw::c_int as isize),
&mut *((*batch).w).as_mut_ptr().offset(7 as std::os::raw::c_int as isize),
0x55555555 as std::os::raw::c_int as uint32_t,
1 as std::os::raw::c_int as aes_word_t,
);
}
...
if num_blocks <= 2 as std::os::raw::c_int as u64 {} else {
__assert_fail(
...
(*batch).w[i as usize],
0xc0c0c0c0 as std::os::raw::c_uint,
);
row1 = aes_nohw_or(
...
aes_nohw_shift_left(
row1,
(16 as std::os::raw::c_int - 1 as std::os::raw::c_int * 4 as std::os::raw::c_int) as aes_word_t,
),
);
row2 = aes_nohw_or(
aes_nohw_shift_right(
...
aes_nohw_shift_left(
row2,
(16 as std::os::raw::c_int - 2 as std::os::raw::c_int * 4 as std::os::raw::c_int) as aes_word_t,
),
);
row3 = aes_nohw_or(
aes_nohw_shift_right(
...
aes_nohw_shift_left(
row3,
(16 as std::os::raw::c_int - 3 as std::os::raw::c_int * 4 as std::os::raw::c_int) as aes_word_t,
),
);
(*batch)
.w[i
...
return v >> 2 as std::os::raw::c_int & 0x3f3f3f3f as std::os::raw::c_int as std::os::raw::c_uint
...
return v >> 4 as std::os::raw::c_int & 0xf0f0f0f as std::os::raw::c_int as std::os::raw::c_uint
...
batch,
&*((*key).keys).as_ptr().offset(0 as std::os::raw::c_int as isize),
);
...
& ((1 as std::os::raw::c_int) << 2 as std::os::raw::c_int) - 1 as std::os::raw::c_int) as uint8_t;
...
.wrapping_sub(1 as std::os::raw::c_int as u64) as usize];
let mut j: size_t = 0 as std::os::raw::c_int as size_t;
while j
...
aes_nohw_compact_block(block2.as_mut_ptr(), in_0.offset(16 as std::os::raw::c_int as isize));
let _ = GFp_memcpy(
((*key).rd_key).as_mut_ptr().offset(4 as std::os::raw::c_int as isize)
as *mut std::os::raw::c_void,
...
i = (i as u64).wrapping_add(2 as std::os::raw::c_int as u64)
as size_t as size_t;
}
}
#[no_mangle]
...
i = (i as u64)
.wrapping_add(std::mem::size_of::<aes_word_t>() as u64) as size_t
as size_t;
}
}
#[no_mangle]
...
ivs
.u32_0[(4 as std::os::raw::c_int as std::os::raw::c_uint)
.wrapping_mul(i_0)
...
out
.offset(
(16 as std::os::raw::c_int as u64).wrapping_mul(i_1) as isize,
),
in_0
.offset(
(16 as std::os::raw::c_int as u64).wrapping_mul(i_1) as isize,
...
ctr = (ctr as std::os::raw::c_uint).wrapping_add(2 as std::os::raw::c_int as std::os::raw::c_uint)
