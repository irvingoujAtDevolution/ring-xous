...
fn GFp_nistz256_select_w5(
out: *mut P256_POINT,
table: *const P256_POINT,
index: crypto_word,
);
...
*dst
.offset(
4 as std::os::raw::c_int as isize,
...
*dst
.offset(
6 as std::os::raw::c_int as isize,
...
static mut START_INDEX: size_t = (256 as std::os::raw::c_int - 1 as std::os::raw::c_int) as size_t;
...
&mut h,
table.as_mut_ptr() as *const P256_POINT,
recoded,
);
...
let mut x2: uint32_t = (x1 & 0xffffffff as std::os::raw::c_uint as u64)
as uint32_t;
...
fiat_p256_mulx_u32(&mut x9, &mut x10, x8, *arg2.offset(7 as std::os::raw::c_int as isize));
let mut x11: uint32_t = 0;
let mut x12: uint32_t = 0;
fiat_p256_mulx_u32(&mut x11, &mut x12, x8, *arg2.offset(6 as std::os::raw::c_int as isize));
let mut x13: uint32_t = 0;
let mut x14: uint32_t = 0;
fiat_p256_mulx_u32(&mut x13, &mut x14, x8, *arg2.offset(5 as std::os::raw::c_int as isize));
let mut x15: uint32_t = 0;
let mut x16: uint32_t = 0;
fiat_p256_mulx_u32(&mut x15, &mut x16, x8, *arg2.offset(4 as std::os::raw::c_int as isize));
let mut x17: uint32_t = 0;
let mut x18: uint32_t = 0;
fiat_p256_mulx_u32(&mut x17, &mut x18, x8, *arg2.offset(3 as std::os::raw::c_int as isize));
let mut x19: uint32_t = 0;
let mut x20: uint32_t = 0;
fiat_p256_mulx_u32(&mut x19, &mut x20, x8, *arg2.offset(2 as std::os::raw::c_int as isize));
let mut x21: uint32_t = 0;
let mut x22: uint32_t = 0;
fiat_p256_mulx_u32(&mut x21, &mut x22, x8, *arg2.offset(1 as std::os::raw::c_int as isize));
let mut x23: uint32_t = 0;
let mut x24: uint32_t = 0;
fiat_p256_mulx_u32(&mut x23, &mut x24, x8, *arg2.offset(0 as std::os::raw::c_int as isize));
...
fiat_p256_addcarryx_u32(&mut x61, &mut x62, x60, x31, 0 as std::os::raw::c_int as uint32_t);
let mut x63: uint32_t = 0;
let mut x64: fiat_p256_uint1 = 0;
fiat_p256_addcarryx_u32(&mut x63, &mut x64, x62, x33, 0 as std::os::raw::c_int as uint32_t);
...
fiat_p256_mulx_u32(&mut x71, &mut x72, x1, *arg2.offset(7 as std::os::raw::c_int as isize));
let mut x73: uint32_t = 0;
let mut x74: uint32_t = 0;
fiat_p256_mulx_u32(&mut x73, &mut x74, x1, *arg2.offset(6 as std::os::raw::c_int as isize));
let mut x75: uint32_t = 0;
let mut x76: uint32_t = 0;
fiat_p256_mulx_u32(&mut x75, &mut x76, x1, *arg2.offset(5 as std::os::raw::c_int as isize));
let mut x77: uint32_t = 0;
let mut x78: uint32_t = 0;
fiat_p256_mulx_u32(&mut x77, &mut x78, x1, *arg2.offset(4 as std::os::raw::c_int as isize));
let mut x79: uint32_t = 0;
let mut x80: uint32_t = 0;
fiat_p256_mulx_u32(&mut x79, &mut x80, x1, *arg2.offset(3 as std::os::raw::c_int as isize));
let mut x81: uint32_t = 0;
let mut x82: uint32_t = 0;
fiat_p256_mulx_u32(&mut x81, &mut x82, x1, *arg2.offset(2 as std::os::raw::c_int as isize));
let mut x83: uint32_t = 0;
let mut x84: uint32_t = 0;
fiat_p256_mulx_u32(&mut x83, &mut x84, x1, *arg2.offset(1 as std::os::raw::c_int as isize));
let mut x85: uint32_t = 0;
let mut x86: uint32_t = 0;
fiat_p256_mulx_u32(&mut x85, &mut x86, x1, *arg2.offset(0 as std::os::raw::c_int as isize));
...
fiat_p256_mulx_u32(&mut x120, &mut x121, x102, 0xffffffff as std::os::raw::c_uint);
let mut x122: uint32_t = 0;
let mut x123: uint32_t = 0;
fiat_p256_mulx_u32(&mut x122, &mut x123, x102, 0xffffffff as std::os::raw::c_uint);
let mut x124: uint32_t = 0;
let mut x125: uint32_t = 0;
fiat_p256_mulx_u32(&mut x124, &mut x125, x102, 0xffffffff as std::os::raw::c_uint);
let mut x126: uint32_t = 0;
let mut x127: uint32_t = 0;
fiat_p256_mulx_u32(&mut x126, &mut x127, x102, 0xffffffff as std::os::raw::c_uint);
...
fiat_p256_mulx_u32(&mut x201, &mut x202, x183, 0xffffffff as std::os::raw::c_uint);
let mut x203: uint32_t = 0;
let mut x204: uint32_t = 0;
fiat_p256_mulx_u32(&mut x203, &mut x204, x183, 0xffffffff as std::os::raw::c_uint);
let mut x205: uint32_t = 0;
let mut x206: uint32_t = 0;
fiat_p256_mulx_u32(&mut x205, &mut x206, x183, 0xffffffff as std::os::raw::c_uint);
let mut x207: uint32_t = 0;
let mut x208: uint32_t = 0;
fiat_p256_mulx_u32(&mut x207, &mut x208, x183, 0xffffffff as std::os::raw::c_uint);
...
fiat_p256_mulx_u32(&mut x282, &mut x283, x264, 0xffffffff as std::os::raw::c_uint);
let mut x284: uint32_t = 0;
let mut x285: uint32_t = 0;
fiat_p256_mulx_u32(&mut x284, &mut x285, x264, 0xffffffff as std::os::raw::c_uint);
let mut x286: uint32_t = 0;
let mut x287: uint32_t = 0;
fiat_p256_mulx_u32(&mut x286, &mut x287, x264, 0xffffffff as std::os::raw::c_uint);
let mut x288: uint32_t = 0;
let mut x289: uint32_t = 0;
fiat_p256_mulx_u32(&mut x288, &mut x289, x264, 0xffffffff as std::os::raw::c_uint);
...
fiat_p256_mulx_u32(&mut x363, &mut x364, x345, 0xffffffff as std::os::raw::c_uint);
let mut x365: uint32_t = 0;
let mut x366: uint32_t = 0;
fiat_p256_mulx_u32(&mut x365, &mut x366, x345, 0xffffffff as std::os::raw::c_uint);
let mut x367: uint32_t = 0;
let mut x368: uint32_t = 0;
fiat_p256_mulx_u32(&mut x367, &mut x368, x345, 0xffffffff as std::os::raw::c_uint);
let mut x369: uint32_t = 0;
let mut x370: uint32_t = 0;
fiat_p256_mulx_u32(&mut x369, &mut x370, x345, 0xffffffff as std::os::raw::c_uint);
...
fiat_p256_mulx_u32(&mut x444, &mut x445, x426, 0xffffffff as std::os::raw::c_uint);
let mut x446: uint32_t = 0;
let mut x447: uint32_t = 0;
fiat_p256_mulx_u32(&mut x446, &mut x447, x426, 0xffffffff as std::os::raw::c_uint);
let mut x448: uint32_t = 0;
let mut x449: uint32_t = 0;
fiat_p256_mulx_u32(&mut x448, &mut x449, x426, 0xffffffff as std::os::raw::c_uint);
let mut x450: uint32_t = 0;
let mut x451: uint32_t = 0;
fiat_p256_mulx_u32(&mut x450, &mut x451, x426, 0xffffffff as std::os::raw::c_uint);
...
fiat_p256_mulx_u32(&mut x525, &mut x526, x507, 0xffffffff as std::os::raw::c_uint);
let mut x527: uint32_t = 0;
let mut x528: uint32_t = 0;
fiat_p256_mulx_u32(&mut x527, &mut x528, x507, 0xffffffff as std::os::raw::c_uint);
let mut x529: uint32_t = 0;
let mut x530: uint32_t = 0;
fiat_p256_mulx_u32(&mut x529, &mut x530, x507, 0xffffffff as std::os::raw::c_uint);
let mut x531: uint32_t = 0;
let mut x532: uint32_t = 0;
fiat_p256_mulx_u32(&mut x531, &mut x532, x507, 0xffffffff as std::os::raw::c_uint);
...
fiat_p256_mulx_u32(&mut x606, &mut x607, x588, 0xffffffff as std::os::raw::c_uint);
let mut x608: uint32_t = 0;
let mut x609: uint32_t = 0;
fiat_p256_mulx_u32(&mut x608, &mut x609, x588, 0xffffffff as std::os::raw::c_uint);
let mut x610: uint32_t = 0;
let mut x611: uint32_t = 0;
fiat_p256_mulx_u32(&mut x610, &mut x611, x588, 0xffffffff as std::os::raw::c_uint);
let mut x612: uint32_t = 0;
let mut x613: uint32_t = 0;
fiat_p256_mulx_u32(&mut x612, &mut x613, x588, 0xffffffff as std::os::raw::c_uint);
...
let mut x9: uint32_t = 0;
let mut x10: uint32_t = 0;
fiat_p256_mulx_u32(&mut x9, &mut x10, x8, *arg1.offset(7 as std::os::raw::c_int as isize));
let mut x11: uint32_t = 0;
let mut x12: uint32_t = 0;
fiat_p256_mulx_u32(&mut x11, &mut x12, x8, *arg1.offset(6 as std::os::raw::c_int as isize));
let mut x13: uint32_t = 0;
let mut x14: uint32_t = 0;
fiat_p256_mulx_u32(&mut x13, &mut x14, x8, *arg1.offset(5 as std::os::raw::c_int as isize));
let mut x15: uint32_t = 0;
let mut x16: uint32_t = 0;
fiat_p256_mulx_u32(&mut x15, &mut x16, x8, *arg1.offset(4 as std::os::raw::c_int as isize));
let mut x17: uint32_t = 0;
let mut x18: uint32_t = 0;
fiat_p256_mulx_u32(&mut x17, &mut x18, x8, *arg1.offset(3 as std::os::raw::c_int as isize));
let mut x19: uint32_t = 0;
let mut x20: uint32_t = 0;
fiat_p256_mulx_u32(&mut x19, &mut x20, x8, *arg1.offset(2 as std::os::raw::c_int as isize));
let mut x21: uint32_t = 0;
let mut x22: uint32_t = 0;
fiat_p256_mulx_u32(&mut x21, &mut x22, x8, *arg1.offset(1 as std::os::raw::c_int as isize));
let mut x23: uint32_t = 0;
let mut x24: uint32_t = 0;
fiat_p256_mulx_u32(&mut x23, &mut x24, x8, *arg1.offset(0 as std::os::raw::c_int as isize));
let mut x25: uint32_t = 0;
let mut x26: fiat_p256_uint1 = 0;
fiat_p256_addcarryx_u32(
&mut x25,
...
let mut x71: uint32_t = 0;
let mut x72: uint32_t = 0;
fiat_p256_mulx_u32(&mut x71, &mut x72, x1, *arg1.offset(7 as std::os::raw::c_int as isize));
let mut x73: uint32_t = 0;
let mut x74: uint32_t = 0;
fiat_p256_mulx_u32(&mut x73, &mut x74, x1, *arg1.offset(6 as std::os::raw::c_int as isize));
let mut x75: uint32_t = 0;
let mut x76: uint32_t = 0;
fiat_p256_mulx_u32(&mut x75, &mut x76, x1, *arg1.offset(5 as std::os::raw::c_int as isize));
let mut x77: uint32_t = 0;
let mut x78: uint32_t = 0;
fiat_p256_mulx_u32(&mut x77, &mut x78, x1, *arg1.offset(4 as std::os::raw::c_int as isize));
let mut x79: uint32_t = 0;
let mut x80: uint32_t = 0;
fiat_p256_mulx_u32(&mut x79, &mut x80, x1, *arg1.offset(3 as std::os::raw::c_int as isize));
let mut x81: uint32_t = 0;
let mut x82: uint32_t = 0;
fiat_p256_mulx_u32(&mut x81, &mut x82, x1, *arg1.offset(2 as std::os::raw::c_int as isize));
let mut x83: uint32_t = 0;
let mut x84: uint32_t = 0;
fiat_p256_mulx_u32(&mut x83, &mut x84, x1, *arg1.offset(1 as std::os::raw::c_int as isize));
let mut x85: uint32_t = 0;
let mut x86: uint32_t = 0;
fiat_p256_mulx_u32(&mut x85, &mut x86, x1, *arg1.offset(0 as std::os::raw::c_int as isize));
let mut x87: uint32_t = 0;
let mut x88: fiat_p256_uint1 = 0;
fiat_p256_addcarryx_u32(
&mut x87,
...
fiat_p256_subborrowx_u32(&mut x19, &mut x20, x18, x3, 0xffffffff as std::os::raw::c_uint);
let mut x21: uint32_t = 0;
let mut x22: fiat_p256_uint1 = 0;
fiat_p256_subborrowx_u32(&mut x21, &mut x22, x20, x5, 0xffffffff as std::os::raw::c_uint);
let mut x23: uint32_t = 0;
let mut x24: fiat_p256_uint1 = 0;
fiat_p256_subborrowx_u32(&mut x23, &mut x24, x22, x7, 0 as std::os::raw::c_int as uint32_t);
let mut x25: uint32_t = 0;
let mut x26: fiat_p256_uint1 = 0;
fiat_p256_subborrowx_u32(&mut x25, &mut x26, x24, x9, 0 as std::os::raw::c_int as uint32_t);
let mut x27: uint32_t = 0;
let mut x28: fiat_p256_uint1 = 0;
fiat_p256_subborrowx_u32(&mut x27, &mut x28, x26, x11, 0 as std::os::raw::c_int as uint32_t);
let mut x29: uint32_t = 0;
let mut x30: fiat_p256_uint1 = 0;
fiat_p256_subborrowx_u32(
&mut x29,
...
let mut x31: uint32_t = 0;
let mut x32: fiat_p256_uint1 = 0;
fiat_p256_subborrowx_u32(&mut x31, &mut x32, x30, x15, 0xffffffff as std::os::raw::c_uint);
let mut x33: uint32_t = 0;
let mut x34: fiat_p256_uint1 = 0;
fiat_p256_subborrowx_u32(
&mut x33,
...
fiat_p256_addcarryx_u32(&mut x24, &mut x25, x23, x7, 0 as std::os::raw::c_int as uint32_t);
let mut x26: uint32_t = 0;
let mut x27: fiat_p256_uint1 = 0;
fiat_p256_addcarryx_u32(&mut x26, &mut x27, x25, x9, 0 as std::os::raw::c_int as uint32_t);
let mut x28: uint32_t = 0;
let mut x29: fiat_p256_uint1 = 0;
fiat_p256_addcarryx_u32(&mut x28, &mut x29, x27, x11, 0 as std::os::raw::c_int as uint32_t);
...
fiat_p256_selectznz(out, (t != 0) as std::os::raw::c_int as fiat_p256_uint1, z, nz);
}
#[no_mangle]
...
fiat_p256_mul(beta.as_mut_ptr(), x_in, gamma.as_mut_ptr() as *const uint32_t);
fiat_p256_sub(ftmp.as_mut_ptr(), x_in, delta.as_mut_ptr() as *const uint32_t);
fiat_p256_add(ftmp2.as_mut_ptr(), x_in, delta.as_mut_ptr() as *const uint32_t);
fiat_p256_add(
tmptmp.as_mut_ptr(),
...
let mut xneq: fiat_p256_limb_t = fiat_p256_nz(
h.as_mut_ptr() as *const fiat_p256_limb_t,
);
fiat_p256_mul(
z_out.as_mut_ptr(),
...
fiat_p256_mul(z1z1z1.as_mut_ptr(), z1, z1z1.as_mut_ptr() as *const uint32_t);
...
let mut yneq: fiat_p256_limb_t = fiat_p256_nz(
r.as_mut_ptr() as *const fiat_p256_limb_t,
);
