...
if num_n == 0 as std::os::raw::c_int as u64 || num_r != num_n
...
carry
|= (v != *a.offset(i.wrapping_add(num_n) as isize)) as std::os::raw::c_int
...
let mut v_0: BN_ULONG = (limbs_sub(r, a as *const Limb, n, num_n))
.wrapping_sub(carry);
