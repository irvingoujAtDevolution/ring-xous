...
let mut x1: uint32_t = (arg1 as std::os::raw::c_uint).wrapping_add(arg2).wrapping_add(arg3);
...
let mut x1: int32_t = arg2.wrapping_sub(arg1 as std::os::raw::c_uint) as int32_t
- arg3 as int32_t;
...
as std::os::raw::c_uint & 0xffffffff as std::os::raw::c_uint;
...
.wrapping_mul(0x26 as std::os::raw::c_int as std::os::raw::c_uint) as u64,
);
let mut x2: uint64_t = (*arg1.offset(9 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(
(*arg2.offset(8 as std::os::raw::c_int as isize))
.wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint) as u64,
);
...
.wrapping_mul(
(*arg2.offset(1 as std::os::raw::c_int as isize))
.wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint) as u64,
);
...
let mut x103: uint32_t = (x101 & 0x3ffffff as std::os::raw::c_uint as u64)
as uint32_t;
let mut x104: uint64_t = x91
.wrapping_add(
x82
.wrapping_add(
x74
...
let mut x143: uint32_t = (x141 & 0x3ffffff as std::os::raw::c_uint as u64)
as uint32_t;
...
.wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint);
let mut x5: uint64_t = (x4 as uint64_t)
.wrapping_mul(0x2 as std::os::raw::c_int as u64);
...
.wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint);
let mut x11: uint64_t = (x10 as uint64_t)
.wrapping_mul(0x2 as std::os::raw::c_int as u64);
...
.wrapping_mul(
x1.wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint) as u64,
);
let mut x20: uint64_t = (*arg1.offset(8 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x2 as u64);
let mut x21: uint64_t = (*arg1.offset(8 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x4 as u64);
let mut x22: uint64_t = (*arg1.offset(7 as std::os::raw::c_int as isize) as u64)
.wrapping_mul(
(x2 as uint64_t).wrapping_mul(0x2 as std::os::raw::c_int as u64),
);
let mut x23: uint64_t = (*arg1.offset(7 as std::os::raw::c_int as isize) as u64)
.wrapping_mul(x5);
let mut x24: uint64_t = (*arg1.offset(7 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(
x7.wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint) as u64,
);
let mut x25: uint64_t = (*arg1.offset(6 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x2 as u64);
let mut x26: uint64_t = (*arg1.offset(6 as std::os::raw::c_int as isize) as u64)
.wrapping_mul(x5);
let mut x27: uint64_t = (*arg1.offset(6 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x8 as u64);
let mut x28: uint64_t = (*arg1.offset(6 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x10 as u64);
let mut x29: uint64_t = (*arg1.offset(5 as std::os::raw::c_int as isize) as u64)
.wrapping_mul(
(x2 as uint64_t).wrapping_mul(0x2 as std::os::raw::c_int as u64),
);
let mut x30: uint64_t = (*arg1.offset(5 as std::os::raw::c_int as isize) as u64)
.wrapping_mul(x5);
let mut x31: uint64_t = (*arg1.offset(5 as std::os::raw::c_int as isize) as u64)
.wrapping_mul(
(x8 as uint64_t).wrapping_mul(0x2 as std::os::raw::c_int as u64),
);
let mut x32: uint64_t = (*arg1.offset(5 as std::os::raw::c_int as isize) as u64)
.wrapping_mul(x11);
let mut x33: uint64_t = (*arg1.offset(5 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(
x13.wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint) as u64,
);
let mut x34: uint64_t = (*arg1.offset(4 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x2 as u64);
let mut x35: uint64_t = (*arg1.offset(4 as std::os::raw::c_int as isize) as u64)
.wrapping_mul(x5);
let mut x36: uint64_t = (*arg1.offset(4 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x8 as u64);
let mut x37: uint64_t = (*arg1.offset(4 as std::os::raw::c_int as isize) as u64)
.wrapping_mul(x11);
let mut x38: uint64_t = (*arg1.offset(4 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x14 as u64);
let mut x39: uint64_t = (*arg1.offset(4 as std::os::raw::c_int as isize) as uint64_t)
...
let mut x41: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as u64)
.wrapping_mul(x5);
let mut x42: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as u64)
.wrapping_mul(
(x8 as uint64_t).wrapping_mul(0x2 as std::os::raw::c_int as u64),
);
let mut x43: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x12 as u64);
let mut x44: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(
x14.wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint) as u64,
);
let mut x45: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x15 as u64);
let mut x46: uint64_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(
(*arg1.offset(3 as std::os::raw::c_int as isize))
.wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint) as u64,
);
let mut x47: uint64_t = (*arg1.offset(2 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x2 as u64);
let mut x48: uint64_t = (*arg1.offset(2 as std::os::raw::c_int as isize) as u64)
.wrapping_mul(x5);
let mut x49: uint64_t = (*arg1.offset(2 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x9 as u64);
let mut x50: uint64_t = (*arg1.offset(2 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x12 as u64);
let mut x51: uint64_t = (*arg1.offset(2 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x14 as u64);
let mut x52: uint64_t = (*arg1.offset(2 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x15 as u64);
let mut x53: uint64_t = (*arg1.offset(2 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x16 as u64);
...
let mut x56: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x6 as u64);
let mut x57: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(
x9.wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint) as u64,
);
let mut x58: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x12 as u64);
let mut x59: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(
x14.wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint) as u64,
);
let mut x60: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x15 as u64);
let mut x61: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(
x16.wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint) as u64,
);
let mut x62: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x17 as u64);
let mut x63: uint64_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(
(*arg1.offset(1 as std::os::raw::c_int as isize))
.wrapping_mul(0x2 as std::os::raw::c_int as std::os::raw::c_uint) as u64,
);
let mut x64: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x3 as u64);
let mut x65: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x6 as u64);
let mut x66: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x9 as u64);
let mut x67: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x12 as u64);
let mut x68: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x14 as u64);
let mut x69: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x15 as u64);
let mut x70: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x16 as u64);
let mut x71: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x17 as u64);
let mut x72: uint64_t = (*arg1.offset(0 as std::os::raw::c_int as isize) as uint64_t)
.wrapping_mul(x18 as u64);
...
let mut x76: uint32_t = (x74 & 0x3ffffff as std::os::raw::c_uint as u64)
as uint32_t;
let mut x77: uint64_t = x64
.wrapping_add(x56.wrapping_add(x49.wrapping_add(x43.wrapping_add(x38))));
let mut x78: uint64_t = x65
.wrapping_add(
x57.wrapping_add(x50.wrapping_add(x44.wrapping_add(x39.wrapping_add(x19)))),
);
let mut x79: uint64_t = x66
.wrapping_add(x58.wrapping_add(x51.wrapping_add(x45.wrapping_add(x20))));
let mut x80: uint64_t = x67
.wrapping_add(
x59.wrapping_add(x52.wrapping_add(x46.wrapping_add(x22.wrapping_add(x21)))),
);
let mut x81: uint64_t = x68
.wrapping_add(x60.wrapping_add(x53.wrapping_add(x25.wrapping_add(x23))));
let mut x82: uint64_t = x69
.wrapping_add(
x61.wrapping_add(x54.wrapping_add(x29.wrapping_add(x26.wrapping_add(x24)))),
);
let mut x83: uint64_t = x70
.wrapping_add(x62.wrapping_add(x34.wrapping_add(x30.wrapping_add(x27))));
let mut x84: uint64_t = x71
.wrapping_add(
x63.wrapping_add(x40.wrapping_add(x35.wrapping_add(x31.wrapping_add(x28)))),
);
let mut x85: uint64_t = x72
.wrapping_add(x47.wrapping_add(x41.wrapping_add(x36.wrapping_add(x32))));
let mut x86: uint64_t = x75.wrapping_add(x85);
let mut x87: uint64_t = x86 >> 25 as std::os::raw::c_int;
let mut x88: uint32_t = (x86 & 0x1ffffff as std::os::raw::c_uint as u64)
as uint32_t;
let mut x89: uint64_t = x87.wrapping_add(x84);
let mut x90: uint64_t = x89 >> 26 as std::os::raw::c_int;
let mut x91: uint32_t = (x89 & 0x3ffffff as std::os::raw::c_uint as u64)
as uint32_t;
let mut x92: uint64_t = x90.wrapping_add(x83);
let mut x93: uint64_t = x92 >> 25 as std::os::raw::c_int;
let mut x94: uint32_t = (x92 & 0x1ffffff as std::os::raw::c_uint as u64)
as uint32_t;
let mut x95: uint64_t = x93.wrapping_add(x82);
let mut x96: uint64_t = x95 >> 26 as std::os::raw::c_int;
let mut x97: uint32_t = (x95 & 0x3ffffff as std::os::raw::c_uint as u64)
as uint32_t;
let mut x98: uint64_t = x96.wrapping_add(x81);
let mut x99: uint64_t = x98 >> 25 as std::os::raw::c_int;
let mut x100: uint32_t = (x98 & 0x1ffffff as std::os::raw::c_uint as u64)
as uint32_t;
...
let mut x106: uint32_t = (x104 & 0x1ffffff as std::os::raw::c_uint as u64)
as uint32_t;
let mut x107: uint64_t = x105.wrapping_add(x78);
let mut x108: uint64_t = x107 >> 26 as std::os::raw::c_int;
let mut x109: uint32_t = (x107 & 0x3ffffff as std::os::raw::c_uint as u64)
as uint32_t;
let mut x110: uint64_t = x108.wrapping_add(x77);
let mut x111: uint64_t = x110 >> 25 as std::os::raw::c_int;
let mut x112: uint32_t = (x110 & 0x1ffffff as std::os::raw::c_uint as u64)
as uint32_t;
...
let mut x116: uint32_t = (x114 & 0x3ffffff as std::os::raw::c_uint as u64)
as uint32_t;
...
let mut x11: uint32_t = (x1 & 0x3ffffff as std::os::raw::c_uint)
.wrapping_add(
(x10 >> 25 as std::os::raw::c_int).wrapping_mul(0x13 as std::os::raw::c_int as std::os::raw::c_uint),
);
...
let mut x1: uint32_t = (*arg1.offset(31 as std::os::raw::c_int as isize) as uint32_t)
<< 18 as std::os::raw::c_int;
let mut x2: uint32_t = (*arg1.offset(30 as std::os::raw::c_int as isize) as uint32_t)
<< 10 as std::os::raw::c_int;
let mut x3: uint32_t = (*arg1.offset(29 as std::os::raw::c_int as isize) as uint32_t)
<< 2 as std::os::raw::c_int;
let mut x4: uint32_t = (*arg1.offset(28 as std::os::raw::c_int as isize) as uint32_t)
<< 20 as std::os::raw::c_int;
let mut x5: uint32_t = (*arg1.offset(27 as std::os::raw::c_int as isize) as uint32_t)
<< 12 as std::os::raw::c_int;
let mut x6: uint32_t = (*arg1.offset(26 as std::os::raw::c_int as isize) as uint32_t)
<< 4 as std::os::raw::c_int;
let mut x7: uint32_t = (*arg1.offset(25 as std::os::raw::c_int as isize) as uint32_t)
<< 21 as std::os::raw::c_int;
let mut x8: uint32_t = (*arg1.offset(24 as std::os::raw::c_int as isize) as uint32_t)
<< 13 as std::os::raw::c_int;
let mut x9: uint32_t = (*arg1.offset(23 as std::os::raw::c_int as isize) as uint32_t)
<< 5 as std::os::raw::c_int;
let mut x10: uint32_t = (*arg1.offset(22 as std::os::raw::c_int as isize) as uint32_t)
<< 23 as std::os::raw::c_int;
let mut x11: uint32_t = (*arg1.offset(21 as std::os::raw::c_int as isize) as uint32_t)
<< 15 as std::os::raw::c_int;
let mut x12: uint32_t = (*arg1.offset(20 as std::os::raw::c_int as isize) as uint32_t)
<< 7 as std::os::raw::c_int;
let mut x13: uint32_t = (*arg1.offset(19 as std::os::raw::c_int as isize) as uint32_t)
<< 24 as std::os::raw::c_int;
let mut x14: uint32_t = (*arg1.offset(18 as std::os::raw::c_int as isize) as uint32_t)
<< 16 as std::os::raw::c_int;
let mut x15: uint32_t = (*arg1.offset(17 as std::os::raw::c_int as isize) as uint32_t)
<< 8 as std::os::raw::c_int;
let mut x16: uint8_t = *arg1.offset(16 as std::os::raw::c_int as isize);
let mut x17: uint32_t = (*arg1.offset(15 as std::os::raw::c_int as isize) as uint32_t)
<< 18 as std::os::raw::c_int;
let mut x18: uint32_t = (*arg1.offset(14 as std::os::raw::c_int as isize) as uint32_t)
<< 10 as std::os::raw::c_int;
let mut x19: uint32_t = (*arg1.offset(13 as std::os::raw::c_int as isize) as uint32_t)
<< 2 as std::os::raw::c_int;
let mut x20: uint32_t = (*arg1.offset(12 as std::os::raw::c_int as isize) as uint32_t)
<< 19 as std::os::raw::c_int;
let mut x21: uint32_t = (*arg1.offset(11 as std::os::raw::c_int as isize) as uint32_t)
<< 11 as std::os::raw::c_int;
let mut x22: uint32_t = (*arg1.offset(10 as std::os::raw::c_int as isize) as uint32_t)
<< 3 as std::os::raw::c_int;
let mut x23: uint32_t = (*arg1.offset(9 as std::os::raw::c_int as isize) as uint32_t)
<< 21 as std::os::raw::c_int;
let mut x24: uint32_t = (*arg1.offset(8 as std::os::raw::c_int as isize) as uint32_t)
<< 13 as std::os::raw::c_int;
let mut x25: uint32_t = (*arg1.offset(7 as std::os::raw::c_int as isize) as uint32_t)
<< 5 as std::os::raw::c_int;
let mut x26: uint32_t = (*arg1.offset(6 as std::os::raw::c_int as isize) as uint32_t)
<< 22 as std::os::raw::c_int;
let mut x27: uint32_t = (*arg1.offset(5 as std::os::raw::c_int as isize) as uint32_t)
<< 14 as std::os::raw::c_int;
let mut x28: uint32_t = (*arg1.offset(4 as std::os::raw::c_int as isize) as uint32_t)
<< 6 as std::os::raw::c_int;
let mut x29: uint32_t = (*arg1.offset(3 as std::os::raw::c_int as isize) as uint32_t)
<< 24 as std::os::raw::c_int;
let mut x30: uint32_t = (*arg1.offset(2 as std::os::raw::c_int as isize) as uint32_t)
<< 16 as std::os::raw::c_int;
let mut x31: uint32_t = (*arg1.offset(1 as std::os::raw::c_int as isize) as uint32_t)
<< 8 as std::os::raw::c_int;
let mut x32: uint8_t = *arg1.offset(0 as std::os::raw::c_int as isize);
let mut x33: uint32_t = (x32 as std::os::raw::c_uint)
.wrapping_add(x31.wrapping_add(x30.wrapping_add(x29)));
...
let mut x40: uint32_t = (x16 as std::os::raw::c_uint)
.wrapping_add(x15.wrapping_add(x14.wrapping_add(x13)));
...
result |= (*in_0.offset(1 as std::os::raw::c_int as isize) as uint64_t) << 8 as std::os::raw::c_int;
result |= (*in_0.offset(2 as std::os::raw::c_int as isize) as uint64_t) << 16 as std::os::raw::c_int;
return result;
}
...
result |= (*in_0.offset(1 as std::os::raw::c_int as isize) as uint64_t) << 8 as std::os::raw::c_int;
result |= (*in_0.offset(2 as std::os::raw::c_int as isize) as uint64_t) << 16 as std::os::raw::c_int;
result |= (*in_0.offset(3 as std::os::raw::c_int as isize) as uint64_t) << 24 as std::os::raw::c_int;
return result;
}
...
s_copy[31 as std::os::raw::c_int
as usize] = (s_copy[31 as std::os::raw::c_int as usize] as std::os::raw::c_int
...
!= *s.offset(31 as std::os::raw::c_int as isize) as std::os::raw::c_int >> 7 as std::os::raw::c_int
{
...
y = (y as std::os::raw::c_uint).wrapping_sub(1 as std::os::raw::c_int as std::os::raw::c_uint) as uint32_t
as uint32_t;
...
- (((-(bnegative as std::os::raw::c_int) & b as std::os::raw::c_int) as uint8_t as std::os::raw::c_int)
...
equal(babs as std::os::raw::c_schar, 1 as std::os::raw::c_int as std::os::raw::c_schar),
);
cmov(
t,
&*(*k25519Precomp.as_ptr().offset(pos as isize))
...
equal(babs as std::os::raw::c_schar, 2 as std::os::raw::c_int as std::os::raw::c_schar),
);
cmov(
t,
&*(*k25519Precomp.as_ptr().offset(pos as isize))
...
equal(babs as std::os::raw::c_schar, 3 as std::os::raw::c_int as std::os::raw::c_schar),
);
cmov(
t,
&*(*k25519Precomp.as_ptr().offset(pos as isize))
...
equal(babs as std::os::raw::c_schar, 4 as std::os::raw::c_int as std::os::raw::c_schar),
);
cmov(
t,
&*(*k25519Precomp.as_ptr().offset(pos as isize))
...
equal(babs as std::os::raw::c_schar, 5 as std::os::raw::c_int as std::os::raw::c_schar),
);
cmov(
t,
&*(*k25519Precomp.as_ptr().offset(pos as isize))
...
equal(babs as std::os::raw::c_schar, 6 as std::os::raw::c_int as std::os::raw::c_schar),
);
cmov(
t,
&*(*k25519Precomp.as_ptr().offset(pos as isize))
...
equal(babs as std::os::raw::c_schar, 7 as std::os::raw::c_int as std::os::raw::c_schar),
);
cmov(
t,
&*(*k25519Precomp.as_ptr().offset(pos as isize))
...
equal(babs as std::os::raw::c_schar, 8 as std::os::raw::c_int as std::os::raw::c_schar),
);
...
#[no_mangle]
pub unsafe extern "C" fn GFp_x25519_ge_scalarmult_base(
mut h: *mut ge_p3,
mut a: *const uint8_t,
) {
...
e[(2 as std::os::raw::c_int * i + 0 as std::os::raw::c_int)
as usize] = (*a.offset(i as isize) as std::os::raw::c_int >> 0 as std::os::raw::c_int
& 15 as std::os::raw::c_int) as std::os::raw::c_schar;
e[(2 as std::os::raw::c_int * i + 1 as std::os::raw::c_int)
as usize] = (*a.offset(i as isize) as std::os::raw::c_int >> 4 as std::os::raw::c_int
& 15 as std::os::raw::c_int) as std::os::raw::c_schar;
i += 1;
}
...
e[i
as usize] = (e[i as usize] as std::os::raw::c_int + carry as std::os::raw::c_int)
as std::os::raw::c_schar;
carry = (e[i as usize] as std::os::raw::c_int + 8 as std::os::raw::c_int) as std::os::raw::c_schar;
carry = (carry as std::os::raw::c_int >> 4 as std::os::raw::c_int) as std::os::raw::c_schar;
e[i
as usize] = (e[i as usize] as std::os::raw::c_int
- ((carry as std::os::raw::c_int) << 4 as std::os::raw::c_int)) as std::os::raw::c_schar;
i += 1;
}
e[63 as std::os::raw::c_int
as usize] = (e[63 as std::os::raw::c_int as usize] as std::os::raw::c_int + carry as std::os::raw::c_int)
as std::os::raw::c_schar;
ge_p3_0(h);
i = 1 as std::os::raw::c_int;
...
>> (i & 7 as std::os::raw::c_int)) as std::os::raw::c_schar;
i += 1;
}
i = 0 as std::os::raw::c_int;
while i < 256 as std::os::raw::c_int {
...
+ ((*r.offset((i + b) as isize) as std::os::raw::c_int) << b))
as std::os::raw::c_schar;
*r.offset((i + b) as isize) = 0 as std::os::raw::c_int as std::os::raw::c_schar;
} else {
if !(*r.offset(i as isize) as std::os::raw::c_int
- ((*r.offset((i + b) as isize) as std::os::raw::c_int) << b)
>= -(15 as std::os::raw::c_int))
...
*r.offset(k as isize) = 1 as std::os::raw::c_int as std::os::raw::c_schar;
break;
} else {
*r.offset(k as isize) = 0 as std::os::raw::c_int as std::os::raw::c_schar;
k += 1;
}
}
}
...
x25519_ge_p3_to_cached(&mut *Ai.as_mut_ptr().offset(0 as std::os::raw::c_int as isize), A);
ge_p3_dbl(&mut t, A);
...
let mut s0: int64_t = (2097151 as std::os::raw::c_int as u64
...
& load_3(s.offset(21 as std::os::raw::c_int as isize) as *const uint8_t)) as int64_t;
...
& load_3(s.offset(42 as std::os::raw::c_int as isize) as *const uint8_t)) as int64_t;
...
s.offset(60 as std::os::raw::c_int as isize) as *const uint8_t,
) >> 3 as std::os::raw::c_int) as int64_t;
...
*s
.offset(
7 as std::os::raw::c_int as isize,
...
*s
.offset(
15 as std::os::raw::c_int as isize,
...
*s
.offset(
18 as std::os::raw::c_int as isize,
...
*s
.offset(
23 as std::os::raw::c_int as isize,
...
*s
.offset(
26 as std::os::raw::c_int as isize,
...
*s
.offset(
28 as std::os::raw::c_int as isize,
...
let mut a0: int64_t = (2097151 as std::os::raw::c_int as u64 & load_3(a))
as int64_t;
let mut a1: int64_t = (2097151 as std::os::raw::c_int as u64
& load_4(a.offset(2 as std::os::raw::c_int as isize)) >> 5 as std::os::raw::c_int) as int64_t;
let mut a2: int64_t = (2097151 as std::os::raw::c_int as u64
& load_3(a.offset(5 as std::os::raw::c_int as isize)) >> 2 as std::os::raw::c_int) as int64_t;
let mut a3: int64_t = (2097151 as std::os::raw::c_int as u64
& load_4(a.offset(7 as std::os::raw::c_int as isize)) >> 7 as std::os::raw::c_int) as int64_t;
let mut a4: int64_t = (2097151 as std::os::raw::c_int as u64
& load_4(a.offset(10 as std::os::raw::c_int as isize)) >> 4 as std::os::raw::c_int) as int64_t;
let mut a5: int64_t = (2097151 as std::os::raw::c_int as u64
& load_3(a.offset(13 as std::os::raw::c_int as isize)) >> 1 as std::os::raw::c_int) as int64_t;
let mut a6: int64_t = (2097151 as std::os::raw::c_int as u64
& load_4(a.offset(15 as std::os::raw::c_int as isize)) >> 6 as std::os::raw::c_int) as int64_t;
let mut a7: int64_t = (2097151 as std::os::raw::c_int as u64
& load_3(a.offset(18 as std::os::raw::c_int as isize)) >> 3 as std::os::raw::c_int) as int64_t;
let mut a8: int64_t = (2097151 as std::os::raw::c_int as u64
& load_3(a.offset(21 as std::os::raw::c_int as isize))) as int64_t;
let mut a9: int64_t = (2097151 as std::os::raw::c_int as u64
& load_4(a.offset(23 as std::os::raw::c_int as isize)) >> 5 as std::os::raw::c_int) as int64_t;
let mut a10: int64_t = (2097151 as std::os::raw::c_int as u64
& load_3(a.offset(26 as std::os::raw::c_int as isize)) >> 2 as std::os::raw::c_int) as int64_t;
let mut a11: int64_t = (load_4(a.offset(28 as std::os::raw::c_int as isize))
>> 7 as std::os::raw::c_int) as int64_t;
let mut b0: int64_t = (2097151 as std::os::raw::c_int as u64 & load_3(b))
as int64_t;
let mut b1: int64_t = (2097151 as std::os::raw::c_int as u64
& load_4(b.offset(2 as std::os::raw::c_int as isize)) >> 5 as std::os::raw::c_int) as int64_t;
let mut b2: int64_t = (2097151 as std::os::raw::c_int as u64
& load_3(b.offset(5 as std::os::raw::c_int as isize)) >> 2 as std::os::raw::c_int) as int64_t;
let mut b3: int64_t = (2097151 as std::os::raw::c_int as u64
& load_4(b.offset(7 as std::os::raw::c_int as isize)) >> 7 as std::os::raw::c_int) as int64_t;
let mut b4: int64_t = (2097151 as std::os::raw::c_int as u64
& load_4(b.offset(10 as std::os::raw::c_int as isize)) >> 4 as std::os::raw::c_int) as int64_t;
let mut b5: int64_t = (2097151 as std::os::raw::c_int as u64
& load_3(b.offset(13 as std::os::raw::c_int as isize)) >> 1 as std::os::raw::c_int) as int64_t;
let mut b6: int64_t = (2097151 as std::os::raw::c_int as u64
& load_4(b.offset(15 as std::os::raw::c_int as isize)) >> 6 as std::os::raw::c_int) as int64_t;
let mut b7: int64_t = (2097151 as std::os::raw::c_int as u64
& load_3(b.offset(18 as std::os::raw::c_int as isize)) >> 3 as std::os::raw::c_int) as int64_t;
let mut b8: int64_t = (2097151 as std::os::raw::c_int as u64
& load_3(b.offset(21 as std::os::raw::c_int as isize))) as int64_t;
let mut b9: int64_t = (2097151 as std::os::raw::c_int as u64
& load_4(b.offset(23 as std::os::raw::c_int as isize)) >> 5 as std::os::raw::c_int) as int64_t;
let mut b10: int64_t = (2097151 as std::os::raw::c_int as u64
& load_3(b.offset(26 as std::os::raw::c_int as isize)) >> 2 as std::os::raw::c_int) as int64_t;
let mut b11: int64_t = (load_4(b.offset(28 as std::os::raw::c_int as isize))
>> 7 as std::os::raw::c_int) as int64_t;
let mut c0: int64_t = (2097151 as std::os::raw::c_int as u64 & load_3(c))
as int64_t;
let mut c1: int64_t = (2097151 as std::os::raw::c_int as u64
& load_4(c.offset(2 as std::os::raw::c_int as isize)) >> 5 as std::os::raw::c_int) as int64_t;
let mut c2: int64_t = (2097151 as std::os::raw::c_int as u64
& load_3(c.offset(5 as std::os::raw::c_int as isize)) >> 2 as std::os::raw::c_int) as int64_t;
let mut c3: int64_t = (2097151 as std::os::raw::c_int as u64
& load_4(c.offset(7 as std::os::raw::c_int as isize)) >> 7 as std::os::raw::c_int) as int64_t;
let mut c4: int64_t = (2097151 as std::os::raw::c_int as u64
& load_4(c.offset(10 as std::os::raw::c_int as isize)) >> 4 as std::os::raw::c_int) as int64_t;
let mut c5: int64_t = (2097151 as std::os::raw::c_int as u64
& load_3(c.offset(13 as std::os::raw::c_int as isize)) >> 1 as std::os::raw::c_int) as int64_t;
let mut c6: int64_t = (2097151 as std::os::raw::c_int as u64
& load_4(c.offset(15 as std::os::raw::c_int as isize)) >> 6 as std::os::raw::c_int) as int64_t;
let mut c7: int64_t = (2097151 as std::os::raw::c_int as u64
& load_3(c.offset(18 as std::os::raw::c_int as isize)) >> 3 as std::os::raw::c_int) as int64_t;
let mut c8: int64_t = (2097151 as std::os::raw::c_int as u64
& load_3(c.offset(21 as std::os::raw::c_int as isize))) as int64_t;
let mut c9: int64_t = (2097151 as std::os::raw::c_int as u64
& load_4(c.offset(23 as std::os::raw::c_int as isize)) >> 5 as std::os::raw::c_int) as int64_t;
let mut c10: int64_t = (2097151 as std::os::raw::c_int as u64
& load_3(c.offset(26 as std::os::raw::c_int as isize)) >> 2 as std::os::raw::c_int) as int64_t;
...
>> (pos & 7 as std::os::raw::c_int)) as std::os::raw::c_uint;
swap ^= b;
...
#[no_mangle]
pub unsafe extern "C" fn GFp_x25519_fe_mul_ttt(
mut h: *mut fe,
mut f: *const fe,
mut g: *const fe,
) {
